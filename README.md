...
- :seedling: I often start small projects in other languages such as `Go`, `Bash`, `Perl` or `JavaScript`.
- :student: I’m currently learning `CI/CD` and `Linux Build Chains`.
